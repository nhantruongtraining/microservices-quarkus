...
public class BookResource {
    ...
    @APIResponses(
            {
                    ...
                    @APIResponse(responseCode = "206", description = "A new book saved on disk")
            }
    )
    ...
    public Response fallbackCreateBook(String title, String author, Integer year, String genre) throws FileNotFoundException {
        Book book = new Book();
